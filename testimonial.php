                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel rounded p-5 wow zoomIn" data-wow-delay="0.6s">
                        <div class="testimonial-item text-center text-white">
                            ...
                            <p class="fs-5">I recently had the pleasure of visiting CareGroup for my dental needs, and I couldn't be happier with the exceptional care I received. From the moment I walked through the doors, I was greeted by a warm and friendly staff who made me feel comfortable and at ease.</p>
                            <hr class="mx-auto w-25">
                            <h4 class="text-white mb-0">Sarah Johnson</h4>
                        </div>
                        <div class="testimonial-item text-center text-white">
                            <img class="img-fluid mx-auto rounded mb-4" src="img/testimonial-2.jpg" alt="">
                            <p class="fs-5">What truly impressed me about CareGroup was their commitment to patient-centered care. The team went above and beyond to create a personalized treatment plan that addressed my specific needs. They were always willing to answer my questions and provide guidance, making me feel like a valued and important part of the dental care process.</p>
                            <hr class="mx-auto w-25">
